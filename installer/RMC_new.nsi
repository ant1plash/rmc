...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRMC ${LANG_ENGLISH} "Remote Media Control Server & Configuration tool"
...
Function CheckPrevInstall
  ...
  ReadRegStr $R0 HKCU "Software\Remote Media Control" ""
  StrCmp $R0 "" done
