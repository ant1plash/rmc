...
namespace RMCSrv
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            SvrThread = new Thread(Server.Listen);
            ...
            if (!config.isCorrect)
            {
                ...
                RunWithUAC(Path.GetDirectoryName(Application.ExecutablePath) + "/" + "RMCConfig", "");
                Environment.Exit(0);
            }
        ...
        private static void RunWithUAC(string ExecutableFileName, string Args)
        {
